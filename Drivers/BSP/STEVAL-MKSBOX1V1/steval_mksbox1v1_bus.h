...
#ifndef STEVAL_MKSBOX1V1_BUS_H
#define STEVAL_MKSBOX1V1_BUS_H
...
/* Includes ------------------------------------------------------------------*/
#include "steval_mksbox1v1_conf.h"
#include "steval_mksbox1v1_errno.h"

/** @addtogroup BSP
  * @{
  */

/** @addtogroup STEVAL_MKSBOX1V1
  * @{
  */

/** @defgroup STEVAL_MKSBOX1V1_BUS STEVAL_MKSBOX1V1 BUS
  * @{
  */

/** @defgroup STEVAL_MKSBOX1V1_BUS_Exported_Constants STEVAL_MKSBOX1V1 BUS Exported Constants
  * @{
  */
...
/** @defgroup STEVAL_MKSBOX1V1_BUS_Private_Types STEVAL_MKSBOX1V1 BUS Private types
  * @{
  */
...
/** @defgroup STEVAL_MKSBOX1V1_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */
...
/** @addtogroup STEVAL_MKSBOX1V1_BUS_Exported_Functions
  * @{
  */
